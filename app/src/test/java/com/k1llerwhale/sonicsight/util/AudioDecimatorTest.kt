 ...
 * mobile/mobile_test_targets.yaml. Golden vectors: committed under
 * src/test/resources/goldens, generated by an independent NumPy oracle kept
 * as a local untracked tool (mobile/tools/, gitignored).
 *
...
class AudioDecimatorTest {
    ...
    /** Committed LCG — byte-for-byte identical to the golden generator's. */
